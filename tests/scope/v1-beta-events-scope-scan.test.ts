...
const batch19RawGuardFiles = [
  { path: "apps/web/app/api/dev/v1-beta-events/route.ts", expectedLfBytes: 75 },
  {
    path: "apps/web/app/dev/v1-beta-events-debug/page.tsx",
    expectedLfBytes: 139,
  },
  { path: "apps/web/package.json", expectedLfBytes: 26 },
  { path: "packages/analytics/package.json", expectedLfBytes: 21 },
  { path: "packages/analytics/src/index.ts", expectedLfBytes: 154 },
  { path: "packages/contracts/src/index.ts", expectedLfBytes: 41 },
  { path: "packages/contracts/src/v1-beta-event.ts", expectedLfBytes: 110 },
  ...
  { path: "vitest.config.ts", expectedLfBytes: 52 },
];
